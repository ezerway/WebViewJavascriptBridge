Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/ezerway/WebViewJavascriptBridge'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'ezerway' => 'faq.ezerway@gmail.com' }
  s.source       = { :git => 'https://github.com/ezerway/WebViewJavascriptBridge.git', :tag => 'v'+s.version.to_s }
